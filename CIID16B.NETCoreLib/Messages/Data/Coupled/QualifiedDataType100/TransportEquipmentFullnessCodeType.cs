...
namespace VertSoft.CrossIndustryInvoice.D16B.Data.QualifiedDataType100.Coupled
{
    ...
    public class TransportEquipmentFullnessCodeType
    {
        ...
        {
            this.listID = "8169";
            this.listAgencyID = TransportEquipmentFullnessCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute()]
        public TransportEquipmentFullnessCodeListAgencyIDContentType listAgencyID { get; set; }
        ...
        [XmlText()]
        public TransportEquipmentFullnessCodeContentType Value { get; set; }
    }
}
