...
namespace VertSoft.CrossIndustryInvoice.D16B.Data.QualifiedDataType100.Coupled
{
    ...
    public class PaymentGuaranteeMeansCodeType
    {
        ...
        {
            this.listID = "4431";
            this.listAgencyID = PaymentGuaranteeMeansCodeListAgencyIDContentType.Item6;
        ...
        [XmlAttribute()]
        public PaymentGuaranteeMeansCodeListAgencyIDContentType listAgencyID { get; set; }
        ...
        [XmlText()]
        public PaymentGuaranteeMeansCodeContentType Value { get; set; }
    }
}
